...
회의록의 핵심은 **빠른 작성**과 **나중에 찾기 쉬움**입니다. 마크다운은 키보드에서 손을 떼지 않고 제목, 목록, [체크리스트](/blog/markdown-checklist-task-list)를 만들 수 있어 회의 중 실시간 기록에 적합합니다. 또 텍스트 기반이라 검색이 쉽고, 어떤 도구에서도 열립니다.
...
회의록을 워드로 제출한다면 [내보낼 때 깨지는 것들](/blog/markdown-to-word-pdf)의 확인 목록을 한 번 훑어보시길 권합니다.
