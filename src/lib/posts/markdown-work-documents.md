...
[노션](/blog/notion-markdown-guide), Confluence, Google Docs 등 훌륭한 협업 도구가 많은데 굳이 마크다운을 쓰는 이유가 있습니다.
...
[회의록](/blog/markdown-meeting-notes)은 일관된 형식이 있어야 나중에 찾아보기 쉽습니다. 다음 템플릿을 팀 내 표준으로 쓰세요.
...
완성한 문서를 워드나 PDF로 제출할 계획이라면 [마크다운을 워드·PDF로 내보낼 때 깨지는 것들](/blog/markdown-to-word-pdf)을 먼저 확인하세요. 표와 접기에서 사고가 가장 많이 납니다.
