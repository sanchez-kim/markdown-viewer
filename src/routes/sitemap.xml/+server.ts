...
const staticRoutes: { path: string; lastmod: string; changefreq: string; priority: string }[] = [
	...
	{ path: '/editor', lastmod: '2026-07-06', changefreq: 'monthly', priority: '0.9' },
	{ path: '/blog', lastmod: '2026-06-09', changefreq: 'weekly', priority: '0.9' },
	...
	{ path: '/use-cases', lastmod: '2026-06-08', changefreq: 'monthly', priority: '0.8' },
	{ path: '/compare', lastmod: '2026-06-08', changefreq: 'monthly', priority: '0.8' },
	{ path: '/shortcuts', lastmod: '2026-06-09', changefreq: 'monthly', priority: '0.6' },
	{ path: '/about', lastmod: '2026-06-08', changefreq: 'monthly', priority: '0.6' },
	{ path: '/faq', lastmod: '2026-07-03', changefreq: 'monthly', priority: '0.6' },
	{ path: '/changelog', lastmod: '2026-06-09', changefreq: 'monthly', priority: '0.6' },
	{ path: '/privacy', lastmod: '2026-06-18', changefreq: 'yearly', priority: '0.4' },
	{ path: '/terms', lastmod: '2026-06-01', changefreq: 'yearly', priority: '0.4' }
];
